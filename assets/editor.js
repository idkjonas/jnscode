...
function share(mode) {
    ...
    if (base64Compressed.length < 2048) {
        ...
        if (mode === "short") {
            const embedLink = `https://embed.jns.gg/${encodeURIComponent(extractTitle()).replace(/%20/g, "+")}?provider=JnsCode+-+Anonymous+code+sharing&providerurl=https://code.jns.gg/&color=f59e0b&image=https://code.jns.gg/assets/logo-32x32.png&imagetype=thumbnail&redirect=${newURL}`
